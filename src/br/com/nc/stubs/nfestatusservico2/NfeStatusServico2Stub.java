 ...
 */
package br.com.nc.stubs.nfestatusservico2;
...
public class NfeStatusServico2Stub extends org.apache.axis2.client.Stub {
	 ...
	 */
	public NfeStatusServico2Stub(org.apache.axis2.context.ConfigurationContext configurationContext, java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
	 ...
	 */
	public NfeStatusServico2Stub(org.apache.axis2.context.ConfigurationContext configurationContext, java.lang.String targetEndpoint, boolean useSeparateListener)
	...
	public NfeStatusServico2Stub(org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
		this(configurationContext, "https://nfe-homologacao.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico2.asmx");
	}
	...
	public NfeStatusServico2Stub() throws org.apache.axis2.AxisFault {
		this("https://nfe-homologacao.svrs.rs.gov.br/ws/NfeStatusServico/NfeStatusServico2.asmx");
	}
	 ...
	 * @param nfeCabecMsg1
	 */
	public NfeStatusServico2Stub.NfeStatusServicoNF2Result nfeStatusServicoNF2(NfeStatusServico2Stub.NfeDadosMsg nfeDadosMsg0,
			NfeStatusServico2Stub.NfeCabecMsgE nfeCabecMsg1) throws java.rmi.RemoteException {
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), nfeDadosMsg0,
					optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", "nfeStatusServicoNF2")),
					new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", "nfeStatusServicoNF2"));
			...
			java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(), NfeStatusServico2Stub.NfeStatusServicoNF2Result.class,
				...
				if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeStatusServicoNF2"))) {
					...
					try {
						java.lang.String exceptionClassName = (java.lang.String) faultExceptionClassNameMap
								.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "nfeStatusServicoNF2"));
	 ...
	 * @param nfeCabecMsg1
	 */
	public void startnfeStatusServicoNF2(NfeStatusServico2Stub.NfeDadosMsg nfeDadosMsg0, NfeStatusServico2Stub.NfeCabecMsgE nfeCabecMsg1,
			final NfeStatusServico2CallbackHandler callback) throws java.rmi.RemoteException {
		org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
		_operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2/nfeStatusServicoNF2");
		_operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
		...
		_operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
			public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
				try {
					...
					java.lang.Object object = fromOM(resultEnv.getBody().getFirstElement(), NfeStatusServico2Stub.NfeStatusServicoNF2Result.class,
	...
	private org.apache.axiom.om.OMElement toOM(NfeStatusServico2Stub.NfeDadosMsg param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
		try {
	...
	private org.apache.axiom.om.OMElement toOM(NfeStatusServico2Stub.NfeStatusServicoNF2Result param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
		try {
	...
	private org.apache.axiom.om.OMElement toOM(NfeStatusServico2Stub.NfeCabecMsgE param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
		try {
	...
	public static class NfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name = nfeCabecMsg Namespace URI =
		 * http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2 Namespace Prefix = ns1
		 */
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
			...
			if (localExtraAttributes != null) {
				for (int i = 0; i < localExtraAttributes.length; i++) {
					writeAttribute(localExtraAttributes[i].getNamespace().getName(), localExtraAttributes[i].getLocalName(), localExtraAttributes[i].getAttributeValue(),
							xmlWriter);
				}
			}
				...
				try {
					...
					for (int i = 0; i < reader.getAttributeCount(); i++) {
						if (!handledAttributes.contains(reader.getAttributeLocalName(i))) {
							...
							org.apache.axiom.om.OMAttribute attr = factory.createOMAttribute(reader.getAttributeLocalName(i),
									factory.createOMNamespace(reader.getAttributeNamespace(i), reader.getAttributePrefix(i)), reader.getAttributeValue(i));
					...
					if (reader.isStartElement()
							&& new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", "cUF").equals(reader.getName())) {
					...
					if (reader.isStartElement()
							&& new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", "versaoDados").equals(reader.getName())) {
						nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "nil");
			...
			public static NfeCabecMsgE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
				...
				try {
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2", "nfeCabecMsg")
	...
	public static class NfeStatusServicoNF2Result implements org.apache.axis2.databinding.ADBBean {
		...
		public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType)
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":nfeStatusServicoNF2Result", xmlWriter);
				} else {
					writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "nfeStatusServicoNF2Result", xmlWriter);
				}
			}
