 ...
 */
package br.com.nc.stubs.recepcaoevento;
...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
     ...
     * @see RecepcaoEvento#nfeRecepcaoEvento
     * @param nfeDadosMsg0
     * @param nfeCabecMsg1
     */
    public NfeRecepcaoEventoResult nfeRecepcaoEvento(
        RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0,
        RecepcaoEventoStub.NfeCabecMsgE nfeCabecMsg1)
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    RecepcaoEventoStub.NfeRecepcaoEventoResult.class,
     ...
     * Serviço destinado à recepção de mensagem de Evento da NF-e.
     * @see RecepcaoEvento#startnfeRecepcaoEvento
     * @param nfeDadosMsg0
     * @param nfeCabecMsg1
     */
    public void startnfeRecepcaoEvento(
        RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg0,
        RecepcaoEventoStub.NfeCabecMsgE nfeCabecMsg1,
        final RecepcaoEventoCallbackHandler callback)
        throws java.rmi.RemoteException {
        org.apache.axis2.client.OperationClient _operationClient = _serviceClient.createClient(_operations[0].getName());
        _operationClient.getOptions()
                        .setAction("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento/nfeRecepcaoEvento");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                public void onMessage(
                    ...
                    try {
                        ...
                        callback.receiveResultnfeRecepcaoEvento((RecepcaoEventoStub.NfeRecepcaoEventoResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(
        RecepcaoEventoStub.NfeDadosMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(RecepcaoEventoStub.NfeDadosMsg.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(
        RecepcaoEventoStub.NfeRecepcaoEventoResult param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(RecepcaoEventoStub.NfeRecepcaoEventoResult.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.om.OMElement toOM(
        RecepcaoEventoStub.NfeCabecMsgE param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(RecepcaoEventoStub.NfeCabecMsgE.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    RecepcaoEventoStub.NfeDadosMsg.MY_QNAME,
                    factory));
