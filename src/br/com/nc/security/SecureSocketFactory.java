 ...
 */
public class SecureSocketFactory implements ProtocolSocketFactory {
     ...
     */
    public SecureSocketFactory(X509Certificate certificate, PrivateKey privateKey, String fileCacerts) {
    ...
    private SSLContext getSSLContext() {
        if (ssl == null) {
            try {
                ...
                System.out.printf("Erro no certificado\n", ex);
            }
        }
        return ssl;
    }
